...
package com.nshmura.feed.presentation.view.transition;
 ...
 */
@TargetApi(Build.VERSION_CODES.LOLLIPOP) public class Pop extends Visibility {
  ...
  @Override public Animator onAppear(ViewGroup sceneRoot, View view, TransitionValues startValues,
    ...
    return new AnimUtil.NoPauseAnimator(ObjectAnimator.ofPropertyValuesHolder(endValues.view,
